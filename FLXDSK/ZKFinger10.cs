...
namespace FLXDSK
{
    ...
    {       
        ...
        public unsafe static extern int BIOKEY_GENTEMPLATE(IntPtr Handle, byte*[] Templates, int TmpCount, byte[] GTemplate);//BIOKEY_GENTEMPLATE
        ...
        [DllImport(ZKFPRI_NAME, EntryPoint = "BIOKEY_IDENTIFY")]
        public static extern int BIOKEY_IDENTIFY(IntPtr handle, byte[] Template1, ref int TID, ref int Score);
    }
}
