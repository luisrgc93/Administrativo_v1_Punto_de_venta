...
namespace FLXDSK.Classes.Catalogos.Administracion
{
    class Class_Roles
    {
        ...
        public DataTable getOpcionesAll()
        {
            string sql = " SELECT 0 AS id, 'Seleccionar' AS nombre " +
                         " UNION ALL " +
                         " SELECT iidRol AS id, vchNombre AS nombre FROM catRoles (NOLOCK) WHERE iidEstatus = 1 ";
        ...
        {
            string sql = " SELECT * FROM catRoles WHERE vchNombre = '" + nombre + "'";
        ...
        {
            string sql = "SELECT iidRol, iidUsuario FROM RelRolesAccesos" +
        ...
        {
            string sql = "SELECT iidRol FROM catRoles WHERE vchNombre = '" + nombreRol  + "'";
